...
const Gallery = () => {
    ...
    const images = [
        {
          original: '/images/gallery/aurora_borealis.jpg',
          thumbnail: '/images/gallery/aurora_borealis_thumb.jpg',
          description: "Aurora Borealis: The bright dancing lights of the aurora are actually collisions between electrically charged particles from the sun that enter the earth's atmosphere. The lights are seen above the magnetic poles of the northern and southern hemispheres. They are known as 'Aurora borealis' in the north and 'Aurora australis' in the south.",
        },
        {
            original: '/images/gallery/sun_erupting.jpg',
            thumbnail: '/images/gallery/sun_erupting_thumb.jpg',
        ...
        {
            original: '/images/gallery/milky_way.jpg',
            thumbnail: '/images/gallery/milky_way_thumb.jpg',
        ...
        {
            original: '/images/gallery/halleys_comet.jpg',
            thumbnail: '/images/gallery/halleys_comet_thumb.jpg',
        ...
        {
            original: '/images/gallery/earth_from_space.jpg',
            thumbnail: '/images/gallery/earth_from_space_thumb.jpg',
        ...
        {
            original: '/images/gallery/moon-surface.jpg',
            thumbnail: '/images/gallery/moon-surface_thumb.jpg',
        ...
        {
            original: '/images/gallery/saturns_rings.jpg',
            thumbnail: '/images/gallery/saturns_rings_thumb.jpg',
        ...
        {
            original: '/images/gallery/apollo17_lunar_roving.jpg',
            thumbnail: '/images/gallery/apollo17_lunar_roving_thumb.jpg',
